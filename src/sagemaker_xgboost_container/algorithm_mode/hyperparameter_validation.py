    ...
    hyperparameters = hpv.Hyperparameters(
        ...
        hpv.ContinuousHyperparameter(name="subsample", range=hpv.Interval(min_open=0, max_closed=1), required=False,
                                     ...
                                     tunable_recommended_range=hpv.Interval(min_closed=0.5, max_closed=1,
                                                                            scale=hpv.Interval.LINEAR_SCALE)),
        hpv.ContinuousHyperparameter(name="colsample_bytree", range=hpv.Interval(min_open=0, max_closed=1), required=False,
                                     tunable=True,
                                     tunable_recommended_range=hpv.Interval(min_closed=0.5, max_closed=1,
                                                                            scale=hpv.Interval.LINEAR_SCALE)),
        hpv.ContinuousHyperparameter(name="colsample_bylevel", range=hpv.Interval(min_open=0, max_closed=1), required=False,
                                     tunable=True,
        ...
        hpv.ContinuousHyperparameter(name="lambda_bias", range=hpv.Interval(min_closed=0, max_closed=1), required=False),
