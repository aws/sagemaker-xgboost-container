...
from sagemaker_xgboost_container.algorithm_mode.server_handler import \
...
class HandlerService(DefaultHandlerService):
    ...
    """
    def __init__(self):
        transformer = Transformer(default_inference_handler=DefaultXGBoostAlgoModeInferenceHandler())
