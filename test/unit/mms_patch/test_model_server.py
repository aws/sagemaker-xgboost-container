...
@patch('sagemaker_xgboost_container.mms_patch.model_server._retrieve_mms_server_process')
@patch('sagemaker_xgboost_container.mms_patch.model_server._add_sigterm_handler')
@patch('sagemaker_xgboost_container.mms_patch.model_server._install_requirements')
@patch('os.path.exists', return_value=True)
@patch('sagemaker_xgboost_container.mms_patch.model_server._create_model_server_config_file')
@patch('sagemaker_xgboost_container.mms_patch.model_server._adapt_to_mms_format')
...
@patch('sagemaker_xgboost_container.mms_patch.model_server._generate_mms_config_properties')
